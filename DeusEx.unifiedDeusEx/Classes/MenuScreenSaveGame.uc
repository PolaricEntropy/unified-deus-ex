...
function ScaleDimensions() {
	...
	snapshotWidth *= dxEnhancedGUIScaleMultiplier;
	snapshotHeight *= dxEnhancedGUIScaleMultiplier;
}
...
function ConfirmSaveGame()
{
	...
	if ((freeDiskSpace / 1024) < minFreeDiskSpace)
	{
		...
		root.MessageBox(DiskSpaceTitle, DiskSpaceMessage, 1, False, Self); // DJ: Hmm...; kocmo: nope
	}
	else
	{
