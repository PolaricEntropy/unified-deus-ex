...
event InitWindow()
{
	...
	// Center this window	
	SetSize(565 * dxEnhancedGUIScaleMultiplier, 420 * dxEnhancedGUIScaleMultiplier);
	SetTitle("Edit Flags");
...
function CreateControls()
{
	...
	// Buttons
	btnAdd    = CreateToolButton(465 * dxEnhancedGUIScaleMultiplier,  60 * dxEnhancedGUIScaleMultiplier, "|&Add");
	btnEdit   = CreateToolButton(465 * dxEnhancedGUIScaleMultiplier,  85 * dxEnhancedGUIScaleMultiplier, "|&Edit");
	btnDelete = CreateToolButton(465 * dxEnhancedGUIScaleMultiplier, 110 * dxEnhancedGUIScaleMultiplier, "|&Delete");
	btnClose  = CreateToolButton(465 * dxEnhancedGUIScaleMultiplier, 368 * dxEnhancedGUIScaleMultiplier, "|&Close");
}
...
{
	CreateToolLabel(16 * dxEnhancedGUIScaleMultiplier, 33 * dxEnhancedGUIScaleMultiplier, "Sort By:");

	// Create a RadioBox window for the boolean radiobuttons
	radSort = RadioBoxWindow(NewChild(Class'RadioBoxWindow'));
	radSort.SetPos(65 * dxEnhancedGUIScaleMultiplier, 30 * dxEnhancedGUIScaleMultiplier);
	radSort.SetSize(180 * dxEnhancedGUIScaleMultiplier, 20 * dxEnhancedGUIScaleMultiplier);
	...
	btnSortName.SetPos(0, 5 * dxEnhancedGUIScaleMultiplier);

	btnSortType = ToolRadioButtonWindow(winSort.NewChild(Class'ToolRadioButtonWindow'));
	btnSortType.SetText("Type");
	btnSortType.SetPos(65 * dxEnhancedGUIScaleMultiplier, 5 * dxEnhancedGUIScaleMultiplier);
...
function CreateFlagsList()
{
	...
	lstFlags = CreateToolList(15 * dxEnhancedGUIScaleMultiplier, 60 * dxEnhancedGUIScaleMultiplier, 425 * dxEnhancedGUIScaleMultiplier, 332 * dxEnhancedGUIScaleMultiplier);
	...
	lstFlags.SetColumnWidth(0, 210 * dxEnhancedGUIScaleMultiplier);
	lstFlags.SetColumnWidth(1, 75 * dxEnhancedGUIScaleMultiplier);
	lstFlags.SetColumnWidth(2, 100 * dxEnhancedGUIScaleMultiplier);
