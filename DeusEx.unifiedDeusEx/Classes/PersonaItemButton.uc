...
function ScaleDimensions() {
	...
	// set up scaling
    iconPosWidth = iconPosWidth * dxEnhancedGUIScaleMultiplier;
    iconPosHeight = iconPosHeight * dxEnhancedGUIScaleMultiplier;
    buttonWidth = buttonWidth * dxEnhancedGUIScaleMultiplier;
    buttonHeight = buttonHeight * dxEnhancedGUIScaleMultiplier;
    borderWidth = borderWidth * dxEnhancedGUIScaleMultiplier;
