...
function UpdateHUDDisplay(DeusExPlayer Player)
{
	...
	DeusExRootWindow(Player.rootWindow).hud.augDisplay.visionLevel = skillLevel;
	DeusExRootWindow(Player.rootWindow).hud.augDisplay.visionLevelValue = sonarDistance;
}
