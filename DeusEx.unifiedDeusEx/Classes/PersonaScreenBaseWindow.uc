...
function ScaleDimensions() {
	...
	screenWidth *= dxEnhancedGUIScaleMultiplier;
	screenHeight *= dxEnhancedGUIScaleMultiplier;
	clientBorderWidth *= dxEnhancedGUIScaleMultiplier;
	clientBorderHeight *= dxEnhancedGUIScaleMultiplier;
	clientBorderOffsetX *= dxEnhancedGUIScaleMultiplier;
	clientBorderOffsetY *= dxEnhancedGUIScaleMultiplier;
	clientWidth *= dxEnhancedGUIScaleMultiplier;
	clientHeight *= dxEnhancedGUIScaleMultiplier;
	clientOffsetX *= dxEnhancedGUIScaleMultiplier;
	clientOffsetY *= dxEnhancedGUIScaleMultiplier;
}
