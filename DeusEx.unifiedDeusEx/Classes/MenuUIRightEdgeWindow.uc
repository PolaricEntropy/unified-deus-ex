...
function ScaleDimensions() {
    ...
    topLeftWidth *= dxEnhancedGUIScaleMultiplier;
    topHeight *= dxEnhancedGUIScaleMultiplier;
    bottomRightHeight *= dxEnhancedGUIScaleMultiplier;
    topRightHeight *= dxEnhancedGUIScaleMultiplier;
    topRightWidth *= dxEnhancedGUIScaleMultiplier;
}
