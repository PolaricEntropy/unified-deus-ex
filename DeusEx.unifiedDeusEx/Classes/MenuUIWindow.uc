...
var class<MenuUIClientWindow>   winClientClass;
...
function ScaleDimensions() {
	...
	clientWidth *= dxEnhancedGUIScaleMultiplier;
	clientHeight *= dxEnhancedGUIScaleMultiplier;
	verticalOffset *= dxEnhancedGUIScaleMultiplier;
	helpPosY *= dxEnhancedGUIScaleMultiplier;
	defaultHelpLeftOffset *= dxEnhancedGUIScaleMultiplier;
	defaultHelpHeight *= dxEnhancedGUIScaleMultiplier;
	defaultHelpClientDiffY *= dxEnhancedGUIScaleMultiplier;
...
function CreateClientWindow()
{
	...
	winClient = MenuUIClientWindow(NewChild(winClientClass));
...
function ProcessMenuAction(EMenuActions action, Class menuActionClass, optional String key)
{
	switch(action)
	{
		...
		case MA_Challenges:
			root.InvokeMenuScreen(class'ChallengeMenu');
			break;
	}
}
...
function MenuUIEditWindow CreateMenuEditWindow(int posX, int posY, int editWidth, int maxChars, Window winParent)
{
	...
	clipName.SetPos(posX + 4 * dxEnhancedGUIScaleMultiplier, posY + 5 * dxEnhancedGUIScaleMultiplier);		// DJ: Hmmm...
...
defaultproperties
{
     ...
     winClientClass=Class'DeusEx.MenuUIClientWindow'
     btnLabelOK="|&OK"
