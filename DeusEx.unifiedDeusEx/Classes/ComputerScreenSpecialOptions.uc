...
function ScaleDimensions() {
	...
	buttonLeftMargin *= dxEnhancedGUIScaleMultiplier;
    firstButtonPosY *= dxEnhancedGUIScaleMultiplier;
    specialOffsetY *= dxEnhancedGUIScaleMultiplier;
    statusPosYOffset *= dxEnhancedGUIScaleMultiplier;
    TopTextureHeight *= dxEnhancedGUIScaleMultiplier;
    MiddleTextureHeight *= dxEnhancedGUIScaleMultiplier;
    BottomTextureHeight *= dxEnhancedGUIScaleMultiplier;
}
