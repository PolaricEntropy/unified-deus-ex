...
event InitWindow()
{
	...
	// Center this window	
	SetSize(370 * dxEnhancedGUIScaleMultiplier, 230 * dxEnhancedGUIScaleMultiplier);
...
function CreateControls()
{
	...
	// Buttons
	btnOpen   = CreateToolButton(280 * dxEnhancedGUIScaleMultiplier, 137 * dxEnhancedGUIScaleMultiplier, "|&Open");
	btnDelete = CreateToolButton(280 * dxEnhancedGUIScaleMultiplier, 162 * dxEnhancedGUIScaleMultiplier, "|&Delete");
	btnCancel = CreateToolButton(280 * dxEnhancedGUIScaleMultiplier, 187 * dxEnhancedGUIScaleMultiplier, "|&Close");
}
...
function CreateDumpList()
{
	...
	lstDumps = CreateToolList(15 * dxEnhancedGUIScaleMultiplier, 38 * dxEnhancedGUIScaleMultiplier, 255 * dxEnhancedGUIScaleMultiplier, 172 * dxEnhancedGUIScaleMultiplier);
	lstDumps.SetColumns(3);
	lstDumps.EnableMultiSelect(False);
	lstDumps.EnableAutoExpandColumns(True);
	lstDumps.SetColumnWidth(0, 100 * dxEnhancedGUIScaleMultiplier);
