...
function FirstFrame()
{
	...
	{
		//Justice: Add a WP grenade to one of the bunks
		if(!flags.GetBool('M15_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(4514.000000, 464.000000, -129.000000)) != None)
				flags.SetBool('M15_WPGrenade_Placed',True);
		}
	}
