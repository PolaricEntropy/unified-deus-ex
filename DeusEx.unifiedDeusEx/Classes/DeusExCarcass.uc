								...
								if ((Weapon(item).AmmoType != None || W.AmmoType != None))
								{
									if((Weapon(item).AmmoType.AmmoAmount > 0 || W.AmmoType.AmmoAmount > 0))
									{
										...
										{ //Justice: Demolition now affects the max grenades you can carry
											if(AmmoType.AmmoAmount < AmmoType.MaxAmmo || (DeusExAmmo(AmmoType).isGrenade && (AmmoType.AmmoAmount < AmmoType.MaxAmmo + 2 * player.SkillSystem.GetSkillLevel(class'SkillDemolition'))))
											{
