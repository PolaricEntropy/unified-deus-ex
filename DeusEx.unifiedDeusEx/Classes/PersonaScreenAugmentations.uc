...
function ScaleDimensions() {
	...
	for (i=0; i<arrayCount(AugLocs); i++) {
		AugLocs[i].X *= dxEnhancedGUIScaleMultiplier;
		AugLocs[i].Y *= dxEnhancedGUIScaleMultiplier;
	}

    augSlotSpacingX *= dxEnhancedGUIScaleMultiplier;
    augSlotSpacingY *= dxEnhancedGUIScaleMultiplier;
}
...
function CreateAugCanWindow()
{
	...
	winAugCans.SetIconSize(
		Class'AugmentationUpgradeCannister'.Default.largeIconWidth * dxEnhancedGUIScaleMultiplier,
		Class'AugmentationUpgradeCannister'.Default.largeIconHeight * dxEnhancedGUIScaleMultiplier);
...
function CreateBioCellWindow()
{
	...
	winBioCells.SetIconSize(
		Class'BioelectricCell'.Default.largeIconWidth * dxEnhancedGUIScaleMultiplier,
		Class'BioelectricCell'.Default.largeIconHeight * dxEnhancedGUIScaleMultiplier);
