...
event InitWindow()
{
	...
	// Center this window	
	SetSize(520 * dxEnhancedGUIScaleMultiplier, 430 * dxEnhancedGUIScaleMultiplier);
...
{
	// Buttons
	btnView    = CreateToolButton(430 * dxEnhancedGUIScaleMultiplier, 287 * dxEnhancedGUIScaleMultiplier, "|&View");
	btnDetails = CreateToolButton(430 * dxEnhancedGUIScaleMultiplier, 312 * dxEnhancedGUIScaleMultiplier, "|&Details");
	btnDelete  = CreateToolButton(430 * dxEnhancedGUIScaleMultiplier, 337 * dxEnhancedGUIScaleMultiplier, "De|&lete");
	btnFiles   = CreateToolButton(430 * dxEnhancedGUIScaleMultiplier, 362 * dxEnhancedGUIScaleMultiplier, "|&Files");
	btnCancel  = CreateToolButton(430 * dxEnhancedGUIScaleMultiplier, 387 * dxEnhancedGUIScaleMultiplier, "|&Close");
...
function CreateLocationsList()
{
	...
	lstLocs = CreateToolList(15 * dxEnhancedGUIScaleMultiplier, 38 * dxEnhancedGUIScaleMultiplier, 405 * dxEnhancedGUIScaleMultiplier, 372 * dxEnhancedGUIScaleMultiplier);
