...
function FirstFrame()
{
	...
	local bool bShifterEnableMiniRocketLauncher;
	...
	else if (localURL == "06_HONGKONG_WANCHAI_STREET")
	{
		...
		//Justice: Add a WP grenade to Jock's apartment
		if(!flags.GetBool('M06_WPGrenade2_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(540.000000, -1264.000000, 1698.000000)) != None)
				flags.SetBool('M06_WPGrenade2_Placed',True);
		}
	}
...
//		}
	...
	{
		//Justice: Add a WP grenade to one of the lockers
		if(!flags.GetBool('M06_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(1758.000000, 880.000000, 228.000000)) != None)
				flags.SetBool('M06_WPGrenade_Placed',True);
		}
	}
