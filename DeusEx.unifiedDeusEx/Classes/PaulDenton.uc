...
defaultproperties
{
     PaulTex(0)=Texture'DeusExCharacters.Skins.PaulDentonTex0'
     PaulTex(1)=Texture'DeusExCharacters.Skins.PaulDentonTex4'
     PaulTex(2)=Texture'DeusExCharacters.Skins.PaulDentonTex5'
     PaulTex(3)=Texture'DeusExCharacters.Skins.PaulDentonTex6'
     PaulTex(4)=Texture'DeusExCharacters.Skins.PaulDentonTex7'
     PaulHandTex(0)=Texture'DeusExCharacters.Skins.PaulDentonTex0'
     PaulHandTex(1)=Texture'DeusExCharacters.Skins.PaulDentonTex4'
     PaulHandTex(2)=Texture'DeusExCharacters.Skins.PaulDentonTex5'
     PaulHandTex(3)=Texture'DeusExCharacters.Skins.PaulDentonTex6'
     PaulHandTex(4)=Texture'DeusExCharacters.Skins.PaulDentonTex7'
