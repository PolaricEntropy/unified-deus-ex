...
defaultproperties
{
     JCTex(0)=Texture'DeusExCharacters.Skins.JCDentonTex0'
     JCTex(1)=Texture'DeusExCharacters.Skins.JCDentonTex4'
     JCTex(2)=Texture'DeusExCharacters.Skins.JCDentonTex5'
     JCTex(3)=Texture'DeusExCharacters.Skins.JCDentonTex6'
     JCTex(4)=Texture'DeusExCharacters.Skins.JCDentonTex7'
