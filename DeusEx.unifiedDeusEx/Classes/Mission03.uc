...
function FirstFrame()
{
	...
	else if (localURL == "03_NYC_UNATCOHQ")
	{
		...
		//Justice: Add a WP grenade to hidden section of the supply closet
		if(!flags.GetBool('M03_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(-429.000000, 737.000000, 307.000000)) != None)
				flags.SetBool('M03_WPGrenade_Placed',True);
		}
	}
