...
{
	local MenuUILabelWindow winLabels[5];
	local int i;

	winLabels[0] = CreateMenuLabel( 21 * dxEnhancedGUIScaleMultiplier,  17 * dxEnhancedGUIScaleMultiplier, HeaderCodeNameLabel,	winClient);
	winLabels[1] = CreateMenuLabel( 21 * dxEnhancedGUIScaleMultiplier,  73 * dxEnhancedGUIScaleMultiplier, HeaderNameLabel,		winClient);
	winLabels[2] = CreateMenuLabel( 21 * dxEnhancedGUIScaleMultiplier, 133 * dxEnhancedGUIScaleMultiplier, HeaderAppearanceLabel,	winClient);
	winLabels[3] = CreateMenuLabel(172 * dxEnhancedGUIScaleMultiplier,  17 * dxEnhancedGUIScaleMultiplier, HeaderSkillsLabel, 		winClient);
	
	CreateMenuLabel(430 * dxEnhancedGUIScaleMultiplier,  18 * dxEnhancedGUIScaleMultiplier, HeaderSkillLevelLabel,   	winClient).SetFont(Font'FontMenuSmall');
	CreateMenuLabel(505 * dxEnhancedGUIScaleMultiplier,  18 * dxEnhancedGUIScaleMultiplier, HeaderPointsNeededLabel,	winClient).SetFont(Font'FontMenuSmall');
	
	winLabels[4] = CreateMenuLabel(409 * dxEnhancedGUIScaleMultiplier, 344 * dxEnhancedGUIScaleMultiplier, HeaderSkillPointsLabel,	winClient);
	
	if (dxEnhancedGUIScaleMultiplier > 1) {
		for (i=0; i<arrayCount(winLabels); i++)
			winLabels[i].SetFont(Font'FontMenuSmall');
	}
}
