...
function bool Facelift(bool bOn)
{
	...
	ret = Super.Facelift(bOn);
	
	if (dxEnhancedGUIScaleMultiplier > 1) { // kocmo: larger icon dimensions for 2x
		largeIconWidth = 55 * dxEnhancedGUIScaleMultiplier;
		largeIconHeight = 44 * dxEnhancedGUIScaleMultiplier;
	}
