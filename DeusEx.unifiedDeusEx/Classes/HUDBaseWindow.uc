...
function ScaleDimensions() {
	...
	backgroundWidth *= dxEnhancedGUIScaleMultiplier;
    backgroundHeight *= dxEnhancedGUIScaleMultiplier;
    backgroundPosX *= dxEnhancedGUIScaleMultiplier;
    backgroundPosY *= dxEnhancedGUIScaleMultiplier;
}
