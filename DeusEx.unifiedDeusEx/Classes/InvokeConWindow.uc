...
event InitWindow()
{
	...
	// Center this window	
	SetSize(375 * dxEnhancedGUIScaleMultiplier, 364 * dxEnhancedGUIScaleMultiplier);
...
{
	// List Box Headers
	CreateToolLabel(18 * dxEnhancedGUIScaleMultiplier, 30 * dxEnhancedGUIScaleMultiplier, "Actors");
	CreateToolLabel(195 * dxEnhancedGUIScaleMultiplier, 30 * dxEnhancedGUIScaleMultiplier, "Conversations");
	CreateToolLabel(18 * dxEnhancedGUIScaleMultiplier, 255 * dxEnhancedGUIScaleMultiplier, "Required Flags");

	// Create Listboxes
	lstActors = CreateToolList( 15 * dxEnhancedGUIScaleMultiplier,  45 * dxEnhancedGUIScaleMultiplier, 165 * dxEnhancedGUIScaleMultiplier, 200 * dxEnhancedGUIScaleMultiplier);
	lstCons   = CreateToolList(192 * dxEnhancedGUIScaleMultiplier,  45 * dxEnhancedGUIScaleMultiplier, 165 * dxEnhancedGUIScaleMultiplier, 200 * dxEnhancedGUIScaleMultiplier);
	lstFlags  = CreateToolList( 15 * dxEnhancedGUIScaleMultiplier, 268 * dxEnhancedGUIScaleMultiplier, 165 * dxEnhancedGUIScaleMultiplier, 80 * dxEnhancedGUIScaleMultiplier);
	
	// Buttons
	btnSetFlags  = CreateToolButton(195 * dxEnhancedGUIScaleMultiplier, 268 * dxEnhancedGUIScaleMultiplier, "|&Set Flags");
	btnEditFlags = CreateToolButton(195 * dxEnhancedGUIScaleMultiplier, 298 * dxEnhancedGUIScaleMultiplier, "|&Edit Flags");
	btnOK        = CreateToolButton(282 * dxEnhancedGUIScaleMultiplier, 268 * dxEnhancedGUIScaleMultiplier, "|&OK");
	btnCancel    = CreateToolButton(282 * dxEnhancedGUIScaleMultiplier, 298 * dxEnhancedGUIScaleMultiplier, "|&Cancel");
}
