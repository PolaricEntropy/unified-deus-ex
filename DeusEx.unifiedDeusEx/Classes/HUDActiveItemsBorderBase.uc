...
function ScaleDimensions() {
	...
	borderTopMargin *= dxEnhancedGUIScaleMultiplier;
	borderBottomMargin *= dxEnhancedGUIScaleMultiplier;
	borderWidth *= dxEnhancedGUIScaleMultiplier;
	topHeight *= dxEnhancedGUIScaleMultiplier;
	topOffset *= dxEnhancedGUIScaleMultiplier;
	bottomHeight *= dxEnhancedGUIScaleMultiplier;
	bottomOffset *= dxEnhancedGUIScaleMultiplier;
	tilePosX *= dxEnhancedGUIScaleMultiplier;
	tilePosY *= dxEnhancedGUIScaleMultiplier;
}
