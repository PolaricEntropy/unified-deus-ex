...
function CreateControls()
{
	...
	btnActionRed   = CreateColorActionButton(41 * dxEnhancedGUIScaleMultiplier, RedLabel);		// DJ: Hmm...
	btnActionGreen = CreateColorActionButton(68 * dxEnhancedGUIScaleMultiplier, GreenLabel);
	btnActionBlue  = CreateColorActionButton(95 * dxEnhancedGUIScaleMultiplier, BlueLabel);

	// Create Sliders
	btnSliderRed   = CreateColorSlider(41 * dxEnhancedGUIScaleMultiplier);
	btnSliderGreen = CreateColorSlider(68 * dxEnhancedGUIScaleMultiplier);
	btnSliderBlue  = CreateColorSlider(95 * dxEnhancedGUIScaleMultiplier);
