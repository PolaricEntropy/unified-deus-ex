...
function ScaleDimensions() {
	...
	// scaling
    titleHeight *= dxEnhancedGUIScaleMultiplier;
    minTitleWidth *= dxEnhancedGUIScaleMultiplier;
    titleLeftMargin *= dxEnhancedGUIScaleMultiplier;
    titleRightMargin *= dxEnhancedGUIScaleMultiplier;
    maxTextWidth *= dxEnhancedGUIScaleMultiplier;
    leftWidth *= dxEnhancedGUIScaleMultiplier;
    rightWidth *= dxEnhancedGUIScaleMultiplier;
    CenterWidth *= dxEnhancedGUIScaleMultiplier;
    leftBottomWidth *= dxEnhancedGUIScaleMultiplier;
    leftBottomHeight *= dxEnhancedGUIScaleMultiplier;
}
...
{	
	...
	// Left bottom
	// DJ: Hmmm...
	gc.DrawTexture(0, titleHeight - 1 * dxEnhancedGUIScaleMultiplier, leftBottomWidth, leftBottomHeight, 0, 0, titleTexture_LeftBottom);
