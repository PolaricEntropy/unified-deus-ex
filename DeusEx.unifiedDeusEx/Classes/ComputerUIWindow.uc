...
function ScaleDimensions() {
    ...
    defaultStatusLeftOffset *= dxEnhancedGUIScaleMultiplier;
    defaultStatusHeight *= dxEnhancedGUIScaleMultiplier;
    defaultStatusClientDiffY *= dxEnhancedGUIScaleMultiplier;
	...
	statusPosY *= dxEnhancedGUIScaleMultiplier;
}
