...
event InitWindow()
{
	...
	// Center this window	
	SetSize(300 * dxEnhancedGUIScaleMultiplier, 250 * dxEnhancedGUIScaleMultiplier);
	SetTitle("Edit Flag");
...
{
	CreateToolLabel(16 * dxEnhancedGUIScaleMultiplier, 33 * dxEnhancedGUIScaleMultiplier, "Flag Type:");
	CreateTypeRadioButtons();

	CreateToolLabel(16 * dxEnhancedGUIScaleMultiplier, 93 * dxEnhancedGUIScaleMultiplier, "Flag Name:");
	editName  = CreateToolEditWindow(16 * dxEnhancedGUIScaleMultiplier, 108 * dxEnhancedGUIScaleMultiplier, 180 * dxEnhancedGUIScaleMultiplier, 32 * dxEnhancedGUIScaleMultiplier);
	editName.SetFilter(" ~`!@#$%^&*()=+\|[{]};:,<.>/?'" $ Chr(34));

	CreateToolLabel(16 * dxEnhancedGUIScaleMultiplier, 143 * dxEnhancedGUIScaleMultiplier, "Mission Expiration (0 = never):");
	editExpiration = CreateToolEditWindow(16 * dxEnhancedGUIScaleMultiplier, 158 * dxEnhancedGUIScaleMultiplier, 180 * dxEnhancedGUIScaleMultiplier, 32 * dxEnhancedGUIScaleMultiplier);
	editExpiration.SetFilter(" ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz~`!@#$%^&*()=+\|[{]};:,<.>/?'" $ Chr(34));

	CreateToolLabel(16 * dxEnhancedGUIScaleMultiplier, 193 * dxEnhancedGUIScaleMultiplier, "Value:");

	CreateBoolControls();

	btnOK     = CreateToolButton(210 * dxEnhancedGUIScaleMultiplier, 180 * dxEnhancedGUIScaleMultiplier, "|&OK");
	btnCancel = CreateToolButton(210 * dxEnhancedGUIScaleMultiplier, 205 * dxEnhancedGUIScaleMultiplier, "|&Cancel");
}
...
function CreateTypeRadioButtons()
{
	...
	radBool.SetPos(20 * dxEnhancedGUIScaleMultiplier, 50 * dxEnhancedGUIScaleMultiplier);
	radBool.SetSize(230 * dxEnhancedGUIScaleMultiplier, 45 * dxEnhancedGUIScaleMultiplier);
...
function CreateBoolControls()
{
	// Create a RadioBox window for the boolean radiobuttons
	radBool = RadioBoxWindow(NewChild(Class'RadioBoxWindow'));
	radBool.SetPos(20 * dxEnhancedGUIScaleMultiplier, 208 * dxEnhancedGUIScaleMultiplier);
	radBool.SetSize(180 * dxEnhancedGUIScaleMultiplier, 20 * dxEnhancedGUIScaleMultiplier);
	...
	btnTrue.SetPos(0, 5 * dxEnhancedGUIScaleMultiplier);

	btnFalse = ToolRadioButtonWindow(winBools.NewChild(Class'ToolRadioButtonWindow'));
	btnFalse.SetText("False");
	btnFalse.SetPos(80 * dxEnhancedGUIScaleMultiplier, 5 * dxEnhancedGUIScaleMultiplier);
}
...
{
	if (editValue == None)
		editValue = CreateToolEditWindow(16 * dxEnhancedGUIScaleMultiplier, 208 * dxEnhancedGUIScaleMultiplier, 180 * dxEnhancedGUIScaleMultiplier, 32 * dxEnhancedGUIScaleMultiplier);
}
