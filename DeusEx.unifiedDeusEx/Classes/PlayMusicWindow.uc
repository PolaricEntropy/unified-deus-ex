...
function CreateControls()
{
	...
	radSongType.SetPos(280 * dxEnhancedGUIScaleMultiplier, 65 * dxEnhancedGUIScaleMultiplier);
	radSongType.SetSize(100 * dxEnhancedGUIScaleMultiplier, 130 * dxEnhancedGUIScaleMultiplier);
	...
	btnCombat.SetPos(0, 20 * dxEnhancedGUIScaleMultiplier);

	btnConversation = ToolRadioButtonWindow(winSongType.NewChild(Class'ToolRadioButtonWindow'));
	btnConversation.SetText("Co|&nvo");
	btnConversation.SetPos(0, 40 * dxEnhancedGUIScaleMultiplier);

	btnOutro = ToolRadioButtonWindow(winSongType.NewChild(Class'ToolRadioButtonWindow'));
	btnOutro.SetText("|&Outro");
	btnOutro.SetPos(0, 60 * dxEnhancedGUIScaleMultiplier);

	btnDying = ToolRadioButtonWindow(winSongType.NewChild(Class'ToolRadioButtonWindow'));
	btnDying.SetText("|&Dying");
	btnDying.SetPos(0, 80 * dxEnhancedGUIScaleMultiplier);

	btnAmbient.SetToggle(True);

	// Buttons
	btnPlay  = CreateToolButton(280 * dxEnhancedGUIScaleMultiplier, 362 * dxEnhancedGUIScaleMultiplier, "Play |&Song");
	btnClose = CreateToolButton(280 * dxEnhancedGUIScaleMultiplier, 387 * dxEnhancedGUIScaleMultiplier, "|&Close");
}
...
function CreateSongsList()
{
	...
	lstSongs = CreateToolList(15 * dxEnhancedGUIScaleMultiplier, 38 * dxEnhancedGUIScaleMultiplier, 255 * dxEnhancedGUIScaleMultiplier, 372 * dxEnhancedGUIScaleMultiplier);
