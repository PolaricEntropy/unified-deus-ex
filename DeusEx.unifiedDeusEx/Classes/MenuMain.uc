...
{
	winTitle = MenuMainUITitleWindow(NewChild(Class'MenuMainUITitleWindow'));
	SetTitle(title);
}
...
function ShowVersionInfo()
{
	...
	version.SetText(player.GetDeusExVersion() $ " - " $ modVersion);
	//version.SetText("Shifter v1.9.1 + BioMod 1.0");
}
...
defaultproperties
{
     ...
     buttonDefaults(5)=(Y=193,Action=MA_Challenges)
     ...
     buttonClass=Class'DeusEx.MenuMainUIMenuButtonWindow'
     ...
     textureCols=2
     winClientClass=Class'DeusEx.MenuMainUIClientWindow'
}
