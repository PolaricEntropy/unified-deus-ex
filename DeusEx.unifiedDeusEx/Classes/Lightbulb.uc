...
{
/*	// want the blue glow in Zodiac
	if (DeusExPlayer(GetPlayerPawn()).Class.Name == 'PaulDentonPlayer') {
		Mesh = mesh(DynamicLoadObject("DeusExItems.SphereEffect", class'mesh', True));
		return true;
	}*/
