...
event InitWindow()
{
    ...
    defaultBarHeight *= dxEnhancedGUIScaleMultiplier;
    buttonSpacing *= dxEnhancedGUIScaleMultiplier;
...
function ConfigurationChanged()
{
	...
	for(buttonIndex=0; buttonIndex<buttonCount; buttonIndex++)
	{
 		...
 		if (btn != None)
		{
			...
			btn.ConfigureChild(btnPos, 1 * dxEnhancedGUIScaleMultiplier, qWidth, qHeight); // DJ: Hmm...
		}			
	}
}
