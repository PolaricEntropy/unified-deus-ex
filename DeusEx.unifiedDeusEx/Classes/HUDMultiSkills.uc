...
var float	skillListX;				// Screen multiplier
var float   skillListY;
var float   skillMsgY;
var float	skillCostX;
var float   skillLevelX;
var int   levelBoxSize;
...
event InitWindow()
{
	...
	skillListX *= dxEnhancedGUIScaleMultiplier;
	skillListY *= dxEnhancedGUIScaleMultiplier;
	skillMsgY *= dxEnhancedGUIScaleMultiplier;
	skillCostX *= dxEnhancedGUIScaleMultiplier;
	skillLevelX *= dxEnhancedGUIScaleMultiplier;
	levelBoxSize *= dxEnhancedGUIScaleMultiplier;
