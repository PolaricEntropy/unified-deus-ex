...
// kocmo: override this one for dimension-doubling logic, and don't forget to call Super
function ScaleDimensions() {
	dxEnhancedGUIScaleMultiplier = player.dxEnhancedGUIScaleMultiplier;
	
	margin *= dxEnhancedGUIScaleMultiplier;
	barLength *= dxEnhancedGUIScaleMultiplier;
}
