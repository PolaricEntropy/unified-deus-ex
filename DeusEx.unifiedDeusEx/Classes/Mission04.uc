...
function FirstFrame()
{
	...
	{
		//Justice: Add a WP grenade behind Smuggler's mirror
		if(!flags.GetBool('M04_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(-566.000000, 1715.000000, 245.000000)) != None)
				flags.SetBool('M04_WPGrenade_Placed',True);
		}
	}
...
defaultproperties
{
     ...
     missionName="Hell's Kitchen - Defection"
}
