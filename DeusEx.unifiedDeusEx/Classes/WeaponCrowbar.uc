...
function bool Facelift(bool bOn)
{
	...
	else
	{
		...
		//largeIcon = Texture(DynamicLoadObject("HDTPItems.Skins.HDTPLargeIconCrowbar", class'Texture')); // unneeded, as .dds overrides are generated from HTDP meshes anyway
