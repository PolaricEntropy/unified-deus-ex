...
function RefreshKeyBindings()
{
	...
	for(keyIndex=0; keyIndex<arrayCount(AliasNames); keyIndex++ )
	{
		...
		lstKeys.SetField(rowId, 1, GetInputDisplayText(keyIndex)); // DJ: Hmm...; kocmo: nope
	}
}
...
defaultproperties
{
     ...
     AliasNames(12)="Jump | StartMantling | OnRelease StopMantling"
     AliasNames(13)="Duck"
     AliasNames(14)="Look"
