...
function ScaleDimensions() {
	...
	defaultHeight *= dxEnhancedGUIScaleMultiplier;
}
...
function ConfigurationChanged()
{
	...
	if (winScroll != None)
	{
		...
		winScroll.ConfigureChild(
			iconWidth + 1 * dxEnhancedGUIScaleMultiplier, 2 * dxEnhancedGUIScaleMultiplier, 
			width - iconWidth - 3 * dxEnhancedGUIScaleMultiplier, height - 4 * dxEnhancedGUIScaleMultiplier); // DJ: Hmmm...
	}
}
