...
function ScaleDimensions() {
	...
	choiceStartX *= dxEnhancedGUIScaleMultiplier;
	choiceStartY *= dxEnhancedGUIScaleMultiplier;
	choiceVerticalGap *= dxEnhancedGUIScaleMultiplier;
	//choiceActionButtonWidth //scaling done in SetActionButtonWidth()
	//panSize *= dxEnhancedGUIScaleMultiplier; // DJ/kocmo: hmmm
