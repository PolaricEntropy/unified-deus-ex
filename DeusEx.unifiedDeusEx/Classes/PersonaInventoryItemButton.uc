...
{	
	...
	if ( !bDragging )
	{
		...
		//if (width < iconPosWidth || height < iconPosHeight)
		//	DeusExRootWindow(GetRootWindow()).MessageBox(anItem.ItemName, "width=" $ width $ ", iconPosWidth=" $ iconPosWidth $ ", height=" $ height $ ", iconPosHeight=" $ iconPosHeight, 1, False, Self);
