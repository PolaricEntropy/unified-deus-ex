...
event InitWindow()
{
	...
	SetSize(200 * dxEnhancedGUIScaleMultiplier, 150 * dxEnhancedGUIScaleMultiplier);

	winText = CreateToolLabel(10 * dxEnhancedGUIScaleMultiplier, 40 * dxEnhancedGUIScaleMultiplier, "");
	winText.SetSize(175 * dxEnhancedGUIScaleMultiplier, 60 * dxEnhancedGUIScaleMultiplier);
}
...
function SetMode( int newMode )
{
	...
	{
		case 0:			// MB_YesNo:
			btnYes = CreateToolButton( 20 * dxEnhancedGUIScaleMultiplier,  110 * dxEnhancedGUIScaleMultiplier, "Yes" );
			btnNo  = CreateToolButton( 106 * dxEnhancedGUIScaleMultiplier, 110 * dxEnhancedGUIScaleMultiplier, "No" );
			SetFocusWindow(btnYes);
			break;

		case 1:			// MB_OK:
			btnOK = CreateToolButton( 63 * dxEnhancedGUIScaleMultiplier, 110 * dxEnhancedGUIScaleMultiplier, "OK" );
