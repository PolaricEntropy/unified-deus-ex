...
event InitWindow()
{
	...
	// set up scaling
	for (i=0; i<2; i++) {
		Left_Textures[i].width *= dxEnhancedGUIScaleMultiplier;
		Right_Textures[i].width *= dxEnhancedGUIScaleMultiplier;
		Center_Textures[i].width *= dxEnhancedGUIScaleMultiplier;
	}
	textOffset *= dxEnhancedGUIScaleMultiplier;
	leftOffset *= dxEnhancedGUIScaleMultiplier;
	buttonVerticalOffset *= dxEnhancedGUIScaleMultiplier;
	rightMargin *= dxEnhancedGUIScaleMultiplier;
	buttonHeight *= dxEnhancedGUIScaleMultiplier;
	minimumButtonWidth *= dxEnhancedGUIScaleMultiplier;

    leftMargin *= dxEnhancedGUIScaleMultiplier;
    fontBaseLine *= dxEnhancedGUIScaleMultiplier;
    fontAcceleratorLineHeight *= dxEnhancedGUIScaleMultiplier;
    verticalTextMargin *= dxEnhancedGUIScaleMultiplier;
    maxTextWidth *= dxEnhancedGUIScaleMultiplier;
...
{
	buttonVerticalOffset = newButtonVerticalOffset * dxEnhancedGUIScaleMultiplier;
}
