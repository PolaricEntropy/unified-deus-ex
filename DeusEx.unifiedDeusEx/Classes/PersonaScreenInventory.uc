...
function ScaleDimensions() {
    ...
    invButtonWidth *= dxEnhancedGUIScaleMultiplier;
    invButtonHeight *= dxEnhancedGUIScaleMultiplier;
    smallInvWidth *= dxEnhancedGUIScaleMultiplier;
    smallInvHeight *= dxEnhancedGUIScaleMultiplier;
}
...
function CreateAmmoWindow()
{
	...
	winAmmo.SetIconSize(Class'AmmoShell'.Default.largeIconWidth * dxEnhancedGUIScaleMultiplier, Class'AmmoShell'.Default.largeIconHeight * dxEnhancedGUIScaleMultiplier);
...
//				if (anItem.largeIconWidth == 0 || anItem.largeIconHeight == 0)
//					DeusExRootWindow(GetRootWindow()).MessageBox(anItem.ItemName, "largeIconWidth=" $ anItem.largeIconWidth $ ", largeIconHeight=" $ anItem.largeIconHeight, 1, False, Self);
