...
function FirstFrame()
{
	...
	if (localURL == "01_NYC_UNATCOISLAND")
	{
	    ...
	    //Justice: Add an WP grenade to the locked chest in the shed
		if(!flags.GetBool('M01_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(-2460.000000, 359.000000, -133.000000)) != None)
				flags.SetBool('M01_WPGrenade_Placed',True);
		}
	}
