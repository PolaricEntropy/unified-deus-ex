...
function FirstFrame()
{
	...
	{
		//Justice: Add a WP to the WiB's cabinet
		if(!flags.GetBool('M11_WPGrenade_Placed'))
		{
			if(spawn(class'WeaponWPGrenade', None,, vect(3555.000000, -2578.000000, -77.000000)) != None)
				flags.SetBool('M11_WPGrenade_Placed',True);
		}
	}
