...
public:
    ...
    INT dxEnhancedGUIScaleMultiplier;
    BITFIELD bHDTP_JC:1 GCC_PACK(4);
    BITFIELD bHDTP_Walton:1;
    BITFIELD bHDTP_Anna:1;
    BITFIELD bHDTP_UNATCO:1;
    BITFIELD bHDTP_MJ12:1;
    BITFIELD bHDTP_NSF:1;
    BITFIELD bHDTP_RiotCop:1;
    BITFIELD bHDTP_Gunther:1;
    BITFIELD bHDTP_Paul:1;
    BITFIELD bHDTP_Nico:1;
    INT bHDTP_ALL GCC_PACK(4);
    FStringNoInit modVersion;
...
public:
    ...
    class ADeusExPlayer* LocalPlayer;
